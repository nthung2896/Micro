...
namespace CommonHelper
{
    ...
    public static class ValidValueData
    {
        ...
        public static resultValidate<bool> CheckValueBool(this string obj, string trueData)
        {
            ...
            if (!string.IsNullOrEmpty(trueData) && obj.ToUpper().Equals(trueData.ToUpper()))
            {
                result.Status = true;
                result.Value = true;
            }
        ...
        public static resultValidate<DateTime> CheckValueDateTime(this string obj)
        {
            ...
            if (!string.IsNullOrEmpty(obj))
            {
                ...
                else
                {
                    ...
                    if (long.TryParse(obj, out long dateNum))
                    {
                        dateData = DateTime.FromOADate(dateNum);
                        result.Value = dateData;
                        result.Status = true;
                    }
                    else
        ...
        public static resultValidate<bool> CheckValueBoolV2(this string obj)
        {
            resultValidate<bool> result = new resultValidate<bool>();
            result.Value = new bool();
            result.Status = true;
            result.Value = obj.ToUpper() == "CÓ" ? true : false;
            return result;
        }
    }
}
