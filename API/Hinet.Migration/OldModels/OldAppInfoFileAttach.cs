...
// POCO khớp 1-1 với bảng dbo.AppInfoFileAttach bên SQL Server cũ.
// Dùng cho Dapper đọc — KHÔNG mapping EF, KHÔNG attribute.
public class OldAppInfoFileAttach
{
    ...
    public long WebsiteId { get; set; } // Trỏ tới AppInfo.Id ở DB cũ
