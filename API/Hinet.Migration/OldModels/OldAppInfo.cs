...
// POCO khớp 1-1 với bảng dbo.AppInfo bên SQL Server cũ.
// Dùng cho Dapper đọc — KHÔNG mapping EF, KHÔNG attribute.
public class OldAppInfo
{
    public long Id { get; set; }
    public int Status { get; set; }
    public string? WebsiteTypeId { get; set; }
    public int AppManageTypeId { get; set; }
    ...
    public string? ListFunctionsUpgradeItemId { get; set; }
