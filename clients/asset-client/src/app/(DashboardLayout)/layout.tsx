...
export default function RootLayout({
  ...
  useEffect(() => {
    // Đặt màu chủ đạo cho phân hệ Quản Lý Tài Sản là tông màu Amber / Vàng cam (#d97706)
    document.documentElement.style.setProperty("--color-primary", "#d97706");
    document.documentElement.style.setProperty("--color-primary-hover", "#f59e0b");
    document.documentElement.style.setProperty("--color-primary-100", "rgba(217, 119, 6, 0.1)");
    document.documentElement.style.setProperty("--color-primary-active", "rgba(217, 119, 6, 0.05)");
  }, []);
