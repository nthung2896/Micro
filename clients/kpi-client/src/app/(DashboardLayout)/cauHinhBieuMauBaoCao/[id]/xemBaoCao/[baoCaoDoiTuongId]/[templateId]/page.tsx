...
const ManagerViewReportTemplatePage: React.FC<PageProps> = ({ params, searchParams }) => {
  ...
  return (
    <>
      ...
      >
        <Flex gap={8} alignItems="center">
          <Button 
            ...
            onClick={() => router.push(`/cauHinhBieuMauBaoCao/${id}/xemBaoCao/${baoCaoDoiTuongId}${month ? `?month=${month}&year=${year}` : ""}`)}
      ...
      <Card title={`Xem biểu mẫu: ${templateData?.name || ""} ${month ? `(Tháng ${month}/${year})` : ""}`} bordered={false} style={{ minHeight: '60vh' }}>
