...
const BaoCaoNenTangLonTheoThang: React.FC = () => {
  ...
  const tableColumns: TableColumnsType<any> = [
    ...
    },
    {
      ...
      onCell: (record) => ({
        onClick: () => {
          router.push(`/cauHinhBieuMauBaoCao/${record.id}`);
        },
      }),
    },
    // {
    ...
    // },
    {
      title: "Ngày gửi mail/thông báo tự động",
    ...
    {
      title: "Người duyệt báo cáo",
      dataIndex: "nameNguoiDuyetBaoCaos",
      width: 200,
      align: "center",
      render: (names: string[]) => (
        <>
    ...
    <>
      ...
      <Flex justifyContent="flex-end" style={{ marginBottom: 12, gap: 8 }}>
        ...
        <Button
          ...
          title={dataList.length > 0 ? "Chỉ được thêm 1 đợt báo cáo" : "Thêm mới"}
          onClick={() => {
...
export default BaoCaoNenTangLonTheoThang;
