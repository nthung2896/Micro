...
const KPI_PhieuDanhGiaPage: React.FC = () => {
  ...
  const tableColumns: TableProps<any>["columns"] = [
    ...
    },
    {
      ...
      render: (_: any, record: any) => {
        ...
        // Lãnh đạo có thể đánh giá khi phiếu đang ở tab choXuLy, hoặc nếu là người tạo ở tab danhGiaTheoDot (trạng thái Khởi tạo/Trả về)
  ...
  return (
    <>
      ...
      <Card className="customCardShadow mb-3" style={{ backgroundColor: '#f4f7fe', border: '1px solid #e2e8f0' }} title={<span style={{ color: '#0355a2' }}>Chọn đợt đánh giá để xem danh sách phiếu</span>}>
        <Row gutter={[16, 16]}>
          <Col span={24}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                <span style={{ fontWeight: 'bold' }}>Đợt đánh giá:</span>
                <Select
                  showSearch
                  style={{ width: 350 }}
              ...
              {phongBanOptions && phongBanOptions.length > 0 && (
                <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                  <span style={{ fontWeight: 'bold', marginLeft: '16px' }}>Phòng ban:</span>
                  <Select
                    showSearch
                    style={{ width: 350 }}
                    placeholder="Chọn phòng ban (Tất cả)"
                    allowClear
