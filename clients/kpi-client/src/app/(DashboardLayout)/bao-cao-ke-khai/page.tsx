...
export default function DoanhNghiepBaoCaoNTNPage() {
        ...
        return (
          <Button
            ...
            onClick={() => {
              if (isSubmitted) {
                router.push(
                  `/bao-cao-ke-khai/${r.idDotBaoCao}/${idFormTemplate}?assignmentId=${r.id}&month=${r.thangBaoCao}&year=${r.namBaoCao}`,
                );
              } else {
                router.push(
                  `/bao-cao-ke-khai/${r.idDotBaoCao}/${idFormTemplate}?assignmentId=${r.id}&month=${r.thangBaoCao}&year=${r.namBaoCao}`,
