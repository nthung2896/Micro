...
const BaoCaoDinhKyHangNamPage: React.FC = () => {
  ...
  const tableColumns: TableColumnsType<any> = [
    ...
    },
    {
      ...
      onCell: (record) => ({
        onClick: () => {
          router.push(`/baoCaoDinhKyHangNam/${record.id}`);
        },
      }),
    },
    {
    ...
    },
    {
      ...
      render: (_: any, record: any) => {
        ...
        const now = dayjs();
        const start = dayjs(record.timeStart);
        const end = dayjs(record.timeEnd);
...
export default BaoCaoDinhKyHangNamPage;
