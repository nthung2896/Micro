    ...
    <LogoWrapper className="logo">
      <Link href="/dashboard" className="flex items-center gap-2 overflow-hidden w-full min-w-0">
        ...
        <div className="flex flex-col justify-center min-w-0 flex-1 leading-tight">
          <div className="text-[15px] sm:text-[18px] lg:text-[19px] font-black text-[#0355a2] tracking-tight truncate uppercase flex items-center gap-1.5">
            <span>ĐÁNH GIÁ KPI</span>
            <span className="text-[10px] bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded border border-blue-300 font-bold">:9696</span>
          </div>
          <div className="text-[11px] text-gray-500 truncate">Hệ Thống Đánh Giá Cán Bộ & Nhiệm Vụ (Base_DB)</div>
        </div>
      </Link>
    </LogoWrapper>
  );
